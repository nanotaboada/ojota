...
| `INSTANT_NOTIFY_DELAY_SECONDS` | 120 | El aviso instantáneo (y el del hook, si hay `PHONE_IP`) se difiere N s; se cancela si volvés en ese lapso. Igual a `RETURN_GRACE_SECONDS` a propósito |
